				...
				<div class="row">
					<div class="navbar-header">
					    <ul class="nav navbar-nav">
					        <li><a href="#me">Про мене</a></li>
					        <li><a href="#advant">Переваги</a></li>
					        <li><a href="#portf">Портфоліо</a></li>  
					        <li><a href="#theme">Схема роботи</a></li>
					        <li><a href="#cost">Вартість</a></li>
					        <li><a href="#oth">Інші послуги</a></li>
					        <li><a href="#foo">Контакти</a></li>
					        <li>
					...
					<div class="obj-slide col-lg-7">
						<div class="obj-slide-wrap-desctop">
							...
							<div class="obj-slide-box obj-slide-comp">
								<div class="obj-slide-items">
									<img class="obj-slide-comp-img" src="assets/img/comp-sl.jpg">
								</div>
								<div class="obj-slide-items">
									<img class="obj-slide-comp-img" src="assets/img/comp-sl.jpg">
								</div>
						...
						<div class="obj-slide  obj-slide-wrap-tablet">
							...
							<div class="obj-slide-tablet">
								<div class="obj-slide-items">
									<img class="obj-slide-tablet-img" src="assets/img/tabl-sl.jpg">
								</div>
								<div class="obj-slide-items">
									<img class="obj-slide-tablet-img" src="assets/img/tabl-sl.jpg">
								</div>
						...
						<div class=" obj-slide obj-slide-wrap-phone">
							...
							<div class="obj-slide-phone obj-slide-box">
								<div class="obj-slide-items">
									<img class="obj-slide-phone-img" src="assets/img/mobi-sl.jpg">
								</div>
								<div class="obj-slide-items">
									<img class="obj-slide-phone-img" src="assets/img/mobi-sl.jpg">
								</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="contact_items col-lg-4">
					...
					<div class="contact-inform"><a href="tel:+38097175-86-11">+38(097) 175-86-11</a></div>
				</div>
				<div class="contact_items col-lg-4">
