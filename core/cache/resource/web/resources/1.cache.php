			...
			<div class="row">
				...
				<div class="serv-title-after">Якщо вам не підходить жоден з тарифів, то я можу скласти для вас індивідуальний - додати послуги з інших тарифів або прибрати ті, які вам не знадобляться.</div>
					...
					<div class="serv-items">
						...
						<i>Що ви отримаєте:</i>
						<ul>
							<li>[{"MIGX_id":"1","li":"ыфвфывфв"}]</li>
						</ul>
					</div>
					<div class="serv-panel">
						<div class="serv-panel-cost">1500<span>грн</span></div>
						<div class="serv-panel-pay">Терміни - 122 <br>Передоплат -3444 грн.</div>
					</div>
...
<head>
	...
	',
    '[[getImageList?
							    &value=`[{"MIGX_id":"1","li":"ыфвфывфв"}]`
                  &tvname=`price-policy__tv`
                  &tpl=`price-policy__ul--item`]]' => '<li>[{"MIGX_id":"1","li":"ыфвфывфв"}]</li>',
    '[[getImageList?
								  &docid=`7`
                  &tvname=`price-policy__tv`
                  &tpl=`price-policy__item`]]' => '<div class="col-md-4">
					<div class="serv-items">
						<h3>Заголовок</h3>
						<i>Що ви отримаєте:</i>
						<ul>
