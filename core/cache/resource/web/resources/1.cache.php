...
<head>
    ...
    '[[$benefits-item]]' => '<div class="benefits-items col-md-4">
					<img src="assets/img/money.svg" alt="money">
					<h3>Мінімальна передплата</h3>
					<div class="benefits-pre">Ви нічим не ризикуєте – працюю за скромною передплатою, оплата за результатами виконаної роботи.</div>
				</div>',
    '[[$portfolio-item]]' => '<div class="portfolio-items col-md-4">
					<div class="portfolio-items__box">
						<img src="assets/img/previ.svg" alt="portfolio">
						<div class="portfolio-ovr">
							<h3>Над проектом працює команда</h3>
    ...
    '[[$price_policy]]' => '<div class="col-md-4">
					<div class="serv-items">
						<h3>Економ</h3>
						<i>Що ви отримаєте:</i>
						<ul>
	...
	<![endif]-->
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<div class="benefits-items col-md-4">
					<img src="assets/img/money.svg" alt="money">
					<h3>Мінімальна передплата</h3>
					<div class="benefits-pre">Ви нічим не ризикуєте – працюю за скромною передплатою, оплата за результатами виконаної роботи.</div>
				</div>',
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="benefits-items col-md-4">
					<img src="assets/img/money.svg" alt="money">
					<h3>Мінімальна передплата</h3>
					<div class="benefits-pre">Ви нічим не ризикуєте – працюю за скромною передплатою, оплата за результатами виконаної роботи.</div>
				</div>',
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<div class="portfolio-items col-md-4">
					<div class="portfolio-items__box">
						<img src="assets/img/previ.svg" alt="portfolio">
						<div class="portfolio-ovr">
							<h3>Над проектом працює команда</h3>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="portfolio-items col-md-4">
					<div class="portfolio-items__box">
						<img src="assets/img/previ.svg" alt="portfolio">
						<div class="portfolio-ovr">
							<h3>Над проектом працює команда</h3>
